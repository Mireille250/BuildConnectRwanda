...
exports.VerificationModule = VerificationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [verification_service_1.VerificationService, cloudinary_service_1.CloudinaryService],
        exports: [verification_service_1.VerificationService, cloudinary_service_1.CloudinaryService],
    })
], VerificationModule);
